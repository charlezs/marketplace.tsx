    ...
    <Center>
      ...
      , #5865F2)"
          ...
          <Text fontSize="13px" color="white">
            Haha Wallet is an Ethereum wallet that offers portfolio tracking and
            investment tools for staying informed on the go. It supports a wide
            range of cryptocurrencies and exchanges, and emphasizes safety and
