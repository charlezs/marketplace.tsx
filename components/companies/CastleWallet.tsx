...
export default function CastleWallet() {
  return (
    <Center>
      <Stack
        w={{ sm: "100%", md: "800px" }}
      ...
      >
        <Box>
          <Image objectFit="cover" boxSize="80px" src="./castle.png" />
        </Box>
      ...
      , #5865F2)"
          ...
          <Text fontSize="13px" color="white">
            Castle is a smart contract wallet for NFT collectors, allowing
            anyone to easily create and manage a shared or personal vault using
            multi-sig wallet technology.{" "}
          </Text>
        </Stack>
      </Stack>
    </Center>
