...
export default function MMWallet() {
  return (
    <Center>
      <Stack
        w={{ sm: "100%", md: "800px" }}
      ...
      >
        <Box>
          <Image objectFit="cover" boxSize="80px" src="./metamask.png" />
        </Box>
      ...
      , #5865F2)"
          ...
          <Text fontSize="13px" color="white">
            Metamask is a browser extension that serves as a wallet for Ethereum
            and other Ethereum-compatible tokens.
          </Text>
        </Stack>
      </Stack>
    </Center>
